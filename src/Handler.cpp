...
// ─────────────────────────────────────────────
// Error response. Uses configured error_page when available.
// ─────────────────────────────────────────────
...
// Path building
// ─────────────────────────────────────────────
// Removes matched location prefix before appending to root.
// Example: location /images root ./www/images + URI /images/cat.png
// becomes ./www/images/cat.png.
...
{
    // Redirects take priority over filesystem lookup.
    ...
    // POST/upload/CGI can plug in here later. The request is valid and allowed,
    // but this handler does not know how to execute it yet.
